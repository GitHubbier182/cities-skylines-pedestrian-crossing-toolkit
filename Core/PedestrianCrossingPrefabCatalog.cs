...
namespace PedestrianCrossingToolkit
{
    public static class PedestrianCrossingPrefabCatalog
    {
        ...
        private static NetInfo _surfaceCrossingPathPrefab;
        private static NetInfo _bridgeDeckPrefab;
        ...
        {
            get { return _surfaceCrossingPathPrefab ?? _pedestrianPathPrefab; }
        }
        ...
        public static NetInfo BridgeDeckPrefab
        {
            get
            {
                ...
                return _bridgeDeckPrefab ?? _pedestrianPathPrefab;
            }
        }
        ...
        public static void Refresh(string reason)
        {
            ...
            try
            {
                ...
                _surfaceCrossingPathPrefab = FindPreferredSurfaceCrossingPath() ?? _pedestrianPathPrefab;
                string pathName = GetPrefabName(_pedestrianPathPrefab);
                _bridgeDeckPrefab = pathName.IndexOf("gravel", StringComparison.Ordinal) >= 0
                    ? FindPreferredBridgeDeckPath()
                    : _pedestrianPathPrefab;
            }
            catch (Exception e)
            {
        ...
        public static void Reset()
        {
            ...
            _pedestrianBridgePrefab = null;
            _pedestrianTunnelPrefab = null;
            _surfaceCrossingPathPrefab = null;
            _bridgeDeckPrefab = null;
        }
