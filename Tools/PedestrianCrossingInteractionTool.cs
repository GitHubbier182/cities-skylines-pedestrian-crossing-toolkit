...
namespace PedestrianCrossingToolkit
{
    public class PedestrianCrossingInteractionTool : ToolBase
    {
        ...
        private int _exclusionZoneBuildNextNodeId;
        ...
        private int _signalGuideJoinBuildNextNodeId;
        ...
        private void ProcessSignalGuideJoinCacheBuild(NetManager netManager)
        {
            ...
            int endNodeId = Mathf.Min(
                nodeLimit,
                _signalGuideJoinBuildNextNodeId + SignalJoinCacheBuildNodeBatchSize);

            EnsurePctSignalExclusionNodes();
            for (int nodeIndex = _signalGuideJoinBuildNextNodeId; nodeIndex < endNodeId; nodeIndex++)
            {
            ...
            if (_signalGuideJoinBuildNextNodeId < nodeLimit)
                return;
        ...
        private void ProcessExclusionZoneCacheBuild(NetManager netManager)
        {
            ...
            for (int nodeIndex = _exclusionZoneBuildNextNodeId; nodeIndex < endNodeId; nodeIndex++)
            {
                ushort nodeId = (ushort)nodeIndex;
                if (IsPctSignalExclusionNode(nodeId))
                    continue;
            ...
            if (_exclusionZoneBuildNextNodeId < nodeLimit)
                return;
