    ...
    public class PedestrianCrossingToolkitPanel : UIPanel
    {
        ...
        public override void Start()
        {
            ...
            _autoScanButton.tooltip =
                "Auto Scan snapshots live pedestrian routes and current non-junction demand.\n"
                + "PCT minimises as 'Snapshotting your city', then reopens with results or preview instructions.\n"
                + "The read-only snapshot is processed cooperatively without a fixed timer.";
