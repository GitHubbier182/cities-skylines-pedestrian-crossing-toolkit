    ...
    public class PedestrianCrossingRoadsTabPanel : UIPanel
    {
        ...
        public override void Start()
        {
            ...
            _autoScanButton = AddButton(
                "Auto Scan — rank junctions from live pedestrian routes, then monitor non-junction demand.",
                "Auto Scan",
                "Snapshots current pedestrian routes and demand, then plans useful crossing proposals across the city.",
